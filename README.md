...
- Simple ground grid to make movement visible; its cell spacing is derived from the loaded ground tile metadata so the world grid fits the tile art instead of leaving oversized empty cells.
