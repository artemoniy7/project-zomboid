...
- GLM isometric camera math with orthographic projection, using a classic 45° horizontal yaw and 35.264° downward pitch so texture-pack tiles stay locked to the isometric view.
